class Colors():
    ...
    def __init__(self):
        ...
        num_colors = 3
        self.black = (0,) * num_colors
        self.gray_33 = (0x33,) * num_colors
        self.gray_66 = (0x66,) * num_colors
        self.gray_99 = (0x99,) * num_colors
        self.gray_AA = (0xAA,) * num_colors
        self.gray_BB = (0xBB,) * num_colors
        self.gray_CC = (0xCC,) * num_colors
        self.gray_DD = (0xDD,) * num_colors
        self.gray_EE = (0xEE,) * num_colors
        self.white = (0xFF,) * num_colors

        self.extra = self.ExtraColors()
